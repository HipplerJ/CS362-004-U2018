...
#define TEST_FILE_NAME "cardtest2.c"                                            // Define global variable for the file name used for testing
...
* number of cards.  Player should draw two treasure cards and then discard 1
* (adventurer) increasing their handsize by a value of one.
*******************************************************************************/
...
* player's deck.  Player Deck size should be reduced by at least 2.
*******************************************************************************/
